...
/**
 * TODO: Remove "THIS FILE IS GENERATED"
 */
...
typedef NS_ENUM(uint32_t, MTRClusterIDType) {
    /**
     * TODO: Ota => OTA
        Reconcile prefix with type, MTRClusterIDType => MTRClusterIDTypeIdentifyID
     */
...
typedef NS_ENUM(uint32_t, MTRClusterAttributeIDType) {
    /**
     * TODO: Turn into: [MTRAttributeIDType][(GlobalAttribute)(GeneratedCommandList)] Note: Look to see if these can be collapsed a
     * little bit
     * TODO: Turn into: [MTRAttributeIDType][(ClusterIdentify)(AttributeIdentifyTime)] Note: possibly remove Attribute
     */
    // Global attributes
...
typedef NS_ENUM(uint32_t, MTRClusterCommandIDType) {
    /**
     * TODO: MTRClusterCommandIDType => MTRCommandIDType, strip trailing ID
     * TODO: Turn into: [MTRCommandIDType][(ClusterIdentify)(AttributeIdentifyTime)] Note: possibly remove Attribute
     */
